...
class UserInput(BaseModel):
    ...
    weight: Annotated[float, Field(..., gt=20, description="Weight of the user")]
    height: Annotated[float, Field(..., gt=0, lt=2.5, description="Height of the user")]
    income_lpa: Annotated[float, Field(..., gt=0, description="Annual income of the user")]
    smoker: Annotated[bool, Field(..., description="User smoke or not")]
    ...
    @classmethod
    def transform_city(cls, city:str) -> str:
